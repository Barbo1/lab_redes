...
void* send_lsu(void* arg)
{
    ...
    unsigned int len = sizeof(sr_ethernet_hdr_t) + sizeof(sr_ip_hdr_t) + sizeof(ospfv2_hdr_t) + sizeof(ospfv2_lsu_hdr_t);
    uint8_t * packet = (uint8_t *)malloc(len * sizeof(uint8_t));
